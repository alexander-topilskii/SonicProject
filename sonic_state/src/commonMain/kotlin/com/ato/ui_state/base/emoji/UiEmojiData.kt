...
// Модель данных для эмодзи
@Serializable
data class UiEmojiData(
    val name: String,
    val slug: String,
    val group: String,
    @SerialName("emoji_version")
    val emojiVersion: String,
    @SerialName("unicode_version")
    val unicodeVersion: String,
    @SerialName("skin_tone_support")
    val skinToneSupport: Boolean,
    @SerialName("skin_tone_support_unicode_version")
    val skinToneSupportUnicodeVersion: String? = null
)
